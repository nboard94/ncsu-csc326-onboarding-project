...
// */
// public EditRecipeStepDefs ( final CoffeeMaker coffeemaker, final
// SharedRecipeData srd ) {
...
// }
// if ( numRecipes > 3 ) {
// throw new IllegalArgumentException( "Number of Recipes cannot be greater than
// 3" );
// }
// else {
//
...
// */
// @When ( "^I submitted valid values for name: (.+); cost: (\\d+); and
// ingredients: (\\d+) coffee, (\\d+) milk, (\\d+) sugar, (\\d+) chocolate$" )
// public void addSpecificRecipe ( final String name, final int cost, final int
// coffeeAmt, final int milkAmt,
...
// */
// private void createRecipe ( final String name, final int price, final int
// amtCoffee, final int amtMilk,
...
// */
// private boolean selectRecipe ( final String name ) throws
...
// */
// @When ( "^I edited that recipe to have cost: (\\d+); and ingredients: (\\d+)
// coffee, (\\d+) milk, (\\d+) sugar, (\\d+) chocolate$" )
// private void editRecipe ( final int price, final int amtCoffee, final int
// amtMilk, final int amtSugar,
...
// * New amount of Chocolate needed for the Recipe
// */
// @When ( "^I invalidly editted that recipe to have cost: (.+); and
// ingredients: (.+) coffee, (.+) milk, (.+) sugar, (.+) chocolate$" )
// public void invalidEditRecipe ( final String cost, final String coffeeAmt,
// final String milkAmt,
...
// Assert.assertNotEquals( "Recipe was edited when it shouldn't have been",
// current, other );
// }
//
// /**
...
// Assert.assertEquals( "Recipe was not edited correctly",
